...
public class PerceptronLayerTanh extends PerceptronLayer
{
    private Allocation   mWeights;
    private Allocation   mResult;
    private ScriptC_dot  mScriptDot;
    private ScriptC_tanh mScriptTanh;

    public PerceptronLayerTanh(RenderScript        renderScript,
                               int                 inputSize,
                               int                 layerSize,
