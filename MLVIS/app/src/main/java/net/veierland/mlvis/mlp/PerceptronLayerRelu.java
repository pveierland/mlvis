...
public class PerceptronLayerRelu extends PerceptronLayer
{
    private Allocation   mWeights;
    private Allocation   mResult;
    private ScriptC_dot  mScriptDot;
    private ScriptC_relu mScriptRelu;

    public PerceptronLayerRelu(RenderScript        renderScript,
                               int                 inputSize,
                               int                 layerSize,
